...
break existing clones once `git remote set-url` is run, but do it deliberately, not as a surprise.

**Deliberately kept private.** Michael authorized building and populating this repo but explicitly
reserved the public/private flip for himself — "we'll do that together when I come back."

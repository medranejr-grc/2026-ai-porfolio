...
> information to share, not mine. The content is unchanged from the original Word document,
> converted to Markdown with light punctuation cleanup (mainly em dashes to plain punctuation) for
> readability. Nexus Retail & Logistics, Agent-Alpha, and the entire incident are a fictional
> teaching scenario; no real company or event is described here.
>
...
- **Policy & Standards Lifecycle:** authoring, publishing, and enforcing security policies, including AI/agentic systems policy, contractor governance, and data handling standards
...
- The absence of any impact assessment before Agent-Alpha's deployment left its failure modes (including confabulation-driven purchasing) entirely unexamined. ISO/IEC 42001's AIMS mandate
...
- Complete discovery audit: all AI agents, service accounts, NPEs across all environments (Months 1–2)
...
- Expand AIMS to cover full AI development lifecycle including pre-production environments (Months 14–18)
...
Security Top 10 / LLM Risks · EU AI Act (Articles 9, 14) · CIS Controls v8 · SOC 2 (CC6.1, Segregation of Duties)
